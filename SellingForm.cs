...
namespace Shop
{
    public partial class SellingForm : Form
    {
        ...
        SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\James\source\repos\wews\shopdb.mdf;Integrated Security=True");
        ...
        private void prodList_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            quantity.Text = prodList.SelectedRows[0].Cells[1].Value.ToString();
            qCheck2.Text = prodList.SelectedRows[0].Cells[1].Value.ToString();
        ...
        private void prodaddbtn_Click(object sender, EventArgs e)
        {
            ...
            else if (Convert.ToInt32(quantity.Text) > Convert.ToInt32(qCheck2.Text))
            {
        ...
        private void activesale_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                prodid.Text = activesale.SelectedRows[0].Cells[0].Value.ToString();
                sName.Text = activesale.SelectedRows[0].Cells[1].Value.ToString();
        ...
        private void prodeditbtn_Click(object sender, EventArgs e)
        {
            ...
            {
                activesale.SelectedRows[0].Cells[0].Value = prodid.Text;
        ...
        private void calculate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    change.Text = "₱ " + Convert.ToString(Convert.ToInt32(paid.Text) - Convert.ToInt32(Gtotal));
                }
            }
        }
        ...
        {
            e.Graphics.DrawString("RIZLYN SANDALS", new Font("Ariel", 30, FontStyle.Bold), Brushes.Maroon, new Point(250));
            
            string showdate = "Date:\t" + date.Text + "\t" + DateTime.Now.ToString("h:mm:ss tt");
            string top = "********************************************************\n";
            string top1 = "\t\tPurchase Receipt \t\n";
            string top2 = "********************************************************\n\n";
            string topunder = "--------------------------------------------------------\n\n";
            string top3 = "Item\tPrice(₱)\tQty\tTotal(₱)\n";
            string down = "***********************************************************\n";
            ...
            while (n < activesale.Rows.Count)
            {
                ...
                AddSales("insert into AllSales (Name, Price, Qty, Total, Date) values ('" + NameU + "','" + PriceU + "','" + QtyU + "','" + TotalU + "','" + DateTime.Now.ToString("dd/M/y h:mm:ss tt") + "')");
        ...
        private void prodidedit_TextChanged(object sender, EventArgs e)
        {
